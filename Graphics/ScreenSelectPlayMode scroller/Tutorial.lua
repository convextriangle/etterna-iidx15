local t = Def.ActorFrame {
	LoadActor("texture/_tutorial.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y+65)
		end;
		OnCommand=function(self)
			self:diffusealpha(0):sleep(.48):diffusealpha(1)
		end;
...
Def.Sprite {
		...
		OnCommand=function(self)
			self:loop(0):diffusealpha(1):setstate(0):sleep(self:GetAnimationLengthSeconds()):diffusealpha(0)
		end;
		GainFocusCommand=function(self)
	...
	LoadActor("texture/style2.png")..{
		...
		OnCommand=function(self)
			self:vertalign(top):zoomy(100):diffusealpha(0):sleep(0.4):diffusealpha(1):linear(0.1):zoomy(1)
		end;
		GainFocusCommand=function(self)
	...
	LoadActor("texture/style4.png")..{
		...
		OnCommand=function(self)
			self:diffusealpha(0):sleep(0.75):linear(0.2):diffusealpha(1)
		end;
		GainFocusCommand=function(self)
	...
	LoadActor("texture/style5.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-239):y(SCREEN_CENTER_Y-48)
		end;
		OnCommand=function(self)
			self:blend('BlendMode_Add'):diffusealpha(0):sleep(0.75):diffusealpha(1)
		end;
		GainFocusCommand=function(self)
	...
	LoadActor("texture/MINI_DECIDE.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-256):y(SCREEN_CENTER_Y-16)
		end;
		OnCommand=function(self)
			self:diffusealpha(0):sleep(0.75):diffusealpha(1)
		end;
		GainFocusCommand=function(self)
	...
	LoadActor("texture/tutorial-info.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y+130)
		end;
		OnCommand=function(self)
			self:diffusealpha(0):addy(-5):sleep(.5):linear(.2):addy(5):diffusealpha(1)
		end;
		GainFocusCommand=function(self)
	...
	LoadActor("texture/tutorial-info.png")..{
		...
		OnCommand=function(self)
			self:blend('BlendMode_Add'):diffusealpha(0):sleep(.7):diffusealpha(1):linear(.05):diffusealpha(0):linear(.05):diffusealpha(1):linear(.05):diffusealpha(0)
		end;
		GainFocusCommand=function(self)
	...
	LoadActor("texture/tutorial-name.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-239):y(SCREEN_CENTER_Y-64)
		end;
		OnCommand=function(self)
			self:diffusealpha(0):sleep(.5):diffusealpha(1)
		end;
		GainFocusCommand=function(self)
			self:stoptweening():diffusealpha(1)
		end;
	...
	LoadActor("texture/tutorial.png")..{
		InitCommand=function(self)
	...
	LoadActor("texture/tutorial-blend.png")..{
		InitCommand=function(self)
	...
	LoadActor("texture/tutorial-stroke.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y-5)
		end;
		OnCommand=function(self)
