local t = Def.ActorFrame {
	LoadActor("texture/_beginner.png")..{
...
Def.Sprite {
	...
	LoadActor("texture/style2.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-144):y(SCREEN_CENTER_Y-88)
		end;
		OnCommand=function(self)
			self:vertalign(top):zoomy(100):diffusealpha(0):sleep(0.45):diffusealpha(1):linear(0.1):zoomy(1)
		end;
	...
	LoadActor("texture/style1.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-144):y(SCREEN_CENTER_Y-136)
		end;
		OnCommand=function(self)
			self:vertalign(top):zoomy(100):diffusealpha(0):sleep(0.45):diffusealpha(1):linear(0.1):zoomy(1)
		end;
	...
	LoadActor("texture/style3.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-144):y(SCREEN_CENTER_Y-48)
		end;
		OnCommand=function(self)
			self:vertalign(top):zoomy(100):diffusealpha(0):sleep(0.45):diffusealpha(1):linear(0.1):zoomy(1)
		end;
	...
	LoadActor("texture/style5.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-143):y(SCREEN_CENTER_Y-48)
		end;
		OnCommand=function(self)
	...
	LoadActor("texture/MINI_DECIDE.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-160):y(SCREEN_CENTER_Y-16)
		end;
		OnCommand=function(self)
			self:diffusealpha(0)
		end;
	...
	LoadActor("texture/beginner-info.png")..{
		InitCommand=function(self)
	...
	LoadActor("texture/beginner-name.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X-144):y(SCREEN_CENTER_Y-64)
		end;
		OnCommand=function(self)
			self:diffusealpha(0):sleep(.55):diffusealpha(1)
		end;
		OffCommand=function(self)
			self:diffusealpha(0)
		end;
	...
	LoadActor("texture/beginner.png")..{
		InitCommand=function(self)
	...
	LoadActor("texture/beginner-blend.png")..{
		InitCommand=function(self)
	...
	LoadActor("texture/beginner-stroke.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y-5)
		end;
		OnCommand=function(self)
