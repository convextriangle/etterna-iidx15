...
Def.Sprite {
	...
	LoadActor("texture/style2.png")..{
		...
		OnCommand=function(self)
			self:vertalign(top):zoomy(100):diffusealpha(0):sleep(0.6):diffusealpha(1):linear(0.1):zoomy(1)
		end;
		GainFocusCommand=function(self)
	...
	LoadActor("texture/style5.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X+145):y(SCREEN_CENTER_Y-48)
		end;
		OnCommand=function(self)
	...
	LoadActor("texture/MINI_DECIDE.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X+128):y(SCREEN_CENTER_Y-16)
		end;
		OnCommand=function(self)
			self:diffusealpha(0)
		end;
	...
	LoadActor("texture/dan-info.png")..{
		InitCommand=function(self)
	...
	LoadActor("texture/dan-name.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X+143):y(SCREEN_CENTER_Y-64)
		end;
		OnCommand=function(self)
			self:diffusealpha(0):sleep(.7):diffusealpha(1)
		end;
		OffCommand=function(self)
			self:diffusealpha(0)
		end;
	...
	LoadActor("texture/dan-blend.png")..{
		InitCommand=function(self)
	...
	LoadActor("texture/dan-stroke.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y-5)
		end;
		OnCommand=function(self)
