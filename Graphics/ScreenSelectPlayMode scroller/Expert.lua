...
Def.Sprite {
	...
	LoadActor("texture/style2.png")..{
		...
		OnCommand=function(self)
			self:vertalign(top):zoomy(100):diffusealpha(0):sleep(0.55):diffusealpha(1):linear(0.1):zoomy(1)
		end;
	...
	LoadActor("texture/style5.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X+49):y(SCREEN_CENTER_Y-48)
		end;
		OnCommand=function(self)
	...
	LoadActor("texture/MINI_DECIDE.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X+32):y(SCREEN_CENTER_Y-16)
		end;
		OnCommand=function(self)
			self:diffusealpha(0)
		end;
	...
	LoadActor("texture/expert-name.png")..{
		...
		OnCommand=function(self)
			self:diffusealpha(0):sleep(.65):diffusealpha(1)
		end;
		OffCommand=function(self)
			self:diffusealpha(0)
		end;
