local t = Def.ActorFrame {
	LoadActor("versus.png")..{
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y-10):visible(GAMESTATE:GetCurrentGame():GetName() == "dance")
		end;
	...
	LoadActor("cursor-dance.png")..{
		InitCommand=function(self)
			self:blend('BlendMode_Add'):x(SCREEN_CENTER_X-1):y(SCREEN_CENTER_Y-10):visible(GAMESTATE:GetCurrentGame():GetName() == "dance")
		end;
		OnCommand=function(self)
			self:diffusealpha(0)
		end;
