local t = Def.ActorFrame{
	...
	LoadActor("1P_TOTAL")..{
	InitCommand=function(self)
		self:horizalign(left):x(25):y(SCREEN_CENTER_Y+204)
	end;
	OnCommand=function(self)
	...
	LoadActor("2P_SCORE")..{
	InitCommand=function(self)
		self:horizalign(right):x(615):y(SCREEN_CENTER_Y-5)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):linear(0.2):addx(-320)
	end;
	...
	InitCommand=function(self)
		self:horizalign(right):x(615):y(SCREEN_CENTER_Y+19)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.05):linear(0.2):addx(-320)
	end;
	...
	LoadActor("2P_MARVS")..{
	InitCommand=function(self)
		self:horizalign(right):x(615):y(SCREEN_CENTER_Y+43)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.1):linear(0.2):addx(-320)
	end;
	...
	InitCommand=function(self)
		self:horizalign(right):x(616):y(SCREEN_CENTER_Y+66)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.15):linear(0.2):addx(-320)
	end;
	...
	Def.Sprite {
		Texture="_GREAT 1x3.png";
			...
			Delay0002=0.01;
	InitCommand=function(self)
		self:horizalign(left):x(521):y(SCREEN_CENTER_Y+41):addx(320):sleep(.15):linear(0.2):addx(-320)
	end;
	};
	LoadActor("2P_GRE")..{
	InitCommand=function(self)
		self:horizalign(right):x(616):y(SCREEN_CENTER_Y+89)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.2):linear(0.2):addx(-320)
	end;
	...
	LoadActor("2P_GOOD")..{
	InitCommand=function(self)
		self:horizalign(right):x(616):y(SCREEN_CENTER_Y+112)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.25):linear(0.2):addx(-320)
	end;
	...
	LoadActor("2P_BAD")..{
	InitCommand=function(self)
		self:horizalign(right):x(616):y(SCREEN_CENTER_Y+135)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.3):linear(0.2):addx(-320)
	end;
	...
	LoadActor("2P_POOR")..{
	InitCommand=function(self)
		self:horizalign(right):x(616):y(SCREEN_CENTER_Y+159)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.35):linear(0.2):addx(-320)
	end;
	...
	LoadActor("ok p2")..{
	InitCommand=function(self)
		self:horizalign(right):x(616):y(SCREEN_CENTER_Y+181)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.35):linear(0.2):addx(-320)
	end;
	...
	LoadActor("2P_TOTAL")..{
	InitCommand=function(self)
		self:horizalign(right):x(616):y(SCREEN_CENTER_Y+204)
	end;
	OnCommand=function(self)
		self:diffusealpha(.9):addx(320):sleep(.4):linear(0.2):addx(-320)
	end;
