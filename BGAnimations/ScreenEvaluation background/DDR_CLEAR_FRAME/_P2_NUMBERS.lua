local t = Def.ActorFrame{
	...
	InitCommand=function(self)
		self:horizalign(left):vertalign(top):x(467):y(SCREEN_CENTER_Y+59)
	end;
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=function(self)
		self:horizalign(left):vertalign(top):x(467):y(SCREEN_CENTER_Y+174)
	end;
	OnCommand=function(self,params)
		local stats = STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2)
			str = string.format("%4d",
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=function(self)
		self:horizalign(right):vertalign(top):x(518):y(SCREEN_CENTER_Y-12)
	end;
	OnCommand=function(self,params)
		local stats = STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2)
	...
	LoadFont("Evaluation Numbers")..{
	InitCommand=function(self)
		self:horizalign(right):vertalign(top):x(518):y(SCREEN_CENTER_Y+196)
	end;
	OnCommand=function(self,params)
